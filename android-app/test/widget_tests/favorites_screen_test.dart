...
import 'package:pensieve/presentation/screens/favorites_screen.dart';
...
void main() {
  group('FavoritesScreen', () {
    testWidgets('displays favorite notes', (tester) async {
      ...
      final router = GoRouter(routes: [
        GoRoute(path: '/', builder: (context, state) => const FavoritesScreen()),
      ]);
